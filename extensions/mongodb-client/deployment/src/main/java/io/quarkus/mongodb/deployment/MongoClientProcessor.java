...
public class MongoClientProcessor {
    private static DotName MONGOCLIENT_ANNOTATION = DotName.createSimple(MongoClientConnection.class.getName());
    ...
    UnremovableBeanBuildItem markBeansAsUnremovable() {
        return new UnremovableBeanBuildItem(new UnremovableBeanBuildItem.BeanDotNameExclusion(UNREMOVABLE_BEAN));
    }
